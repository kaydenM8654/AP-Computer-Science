        ...
        try {
            ...
            for(int r = 0; r < horseRows; r++){
                for(int p = 0; p < horsePens; p++){
                    ...
                    Horse wow = new Horse(name, weight, hayEaten, cornEaten, rides, rideCost);
                    animals.add(wow);
                    hay -= hayEaten;
                    corn -= cornEaten;
                }
            ...
            //TODO: report income for the day, cumlative weight of all animals,if theres enough food to feed all, cow that makes most money
